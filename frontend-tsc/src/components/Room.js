...
function Room({ name, localAudioTrack, localVideoTrack }) {
    ...
    const [remoteWidth, setRemoteWidth] = useState(0);
    ...
    const [widthVideoMobile, setWidthVideoMobile] = useState(0);
    useEffect(() => {
    ...
    return (_jsxs(_Fragment, { children: [RemoteCursor && _jsx(RemoteCursor, { style: {
                    //@ts-ignore
                    left: `${remoteMousePosition?.x + remoteWidth + diffWidth}px`,
                    //@ts-ignore
                    top: `${remoteMousePosition?.y + diffHeight}px`,
                    zIndex: 999
                }, children: strangerName }), mobileWidth ?
                _jsxs(MobileContainer, { style: { height: window.innerHeight }, children: [_jsxs(VideoContainer, { children: [_jsx("video", { autoPlay: true, 
                                    //@ts-ignore
                                    width: widthVideoMobile, ref: localVideoRef }), _jsx("video", { autoPlay: true, 
                                    //@ts-ignore
                                    width: widthVideoMobile, ref: remoteVideoRef })] }), _jsxs(Tic, { onMouseMove: handleMouseMove, onMouseDown: handleMouseDown, children: [_jsxs("div", { style: { color: 'red' }, children: ["Stranger's Name:", strangerName] }), _jsxs("div", { style: { color: 'red' }, children: ["Stranger's Location:", strangerCity] }), _jsx("div", { style: { marginTop: 25 }, children: _jsx("button", { onClick: handleReset, children: "Reset" }) }), _jsx("div", { style: { marginTop: 25, fontSize: 30 }, children: winner ? `Winner ${winVal}` : '' }), matrix.map((row, rowIndex) => (_jsx("div", { children: row.map((Element, colIndex) => (_jsx("button", { style: { color: 'red' }, disabled: disable, onClick: (e) => handleClick(rowIndex, colIndex), children: Element }, colIndex))) }, rowIndex))), !winner ? (_jsx("div", { style: { marginTop: 25, fontSize: 30, color: 'green' }, children: draw ? `Draw ` : `Player ${preVal} Turn` })) : ''] }), _jsxs(ChatContainer, { children: [_jsx(Scroll, { children: chatArr.map((val, index) => _jsx(Chat, { ref: scrollRef, style: { color: `${val?.Stranger ? val?.Stranger.random : val?.You.random}` }, children: val?.Stranger ? `Stranger:${val?.Stranger.chat}` : `You:${val?.You.chat}` }, index)) }), _jsxs("div", { style: { display: 'flex', gap: 5, width: '100vw' }, children: [_jsx("input", { autoFocus: false, ref: inputRef, type: "text", style: { width: '100%', fontSize: 16, height: 25, pointerEvents: 'all' }, onKeyDown: handleKeyDown, value: chat, onChange: (e) => {
                                                setChat(e.target.value);
                                            } }), _jsx("button", { ref: buttonRef, style: { color: 'red', padding: 0, height: 25, pointerEvents: 'all' }, onClick: (e) => handleChat(e), children: "Send" })] })] })] })
                :
                    (_jsx(_Fragment, { children: _jsxs(Container, { children: [_jsxs(Tic, { onMouseMove: handleMouseMove, onMouseDown: handleMouseDown, children: [_jsx("video", { autoPlay: true, width: remoteWidth, height: 190, ref: localVideoRef }), _jsxs("div", { style: { color: 'red' }, children: ["Stranger's Name:", strangerName] }), _jsxs("div", { style: { color: 'red' }, children: ["Stranger's Location:", strangerCity] }), _jsx("div", { style: { marginTop: 25 }, children: _jsx("button", { onClick: handleReset, children: "Reset" }) }), _jsx("div", { style: { marginTop: 25, fontSize: 30 }, children: winner ? `Winner ${winVal}` : '' }), matrix.map((row, rowIndex) => (_jsx("div", { children: row.map((Element, colIndex) => (_jsx("button", { style: { color: 'red' }, disabled: disable, onClick: (e) => handleClick(rowIndex, colIndex), children: Element }, colIndex))) }, rowIndex))), !winner ? (_jsx("div", { style: { marginTop: 25, fontSize: 30, color: 'green' }, children: draw ? `Draw ` : `Player ${preVal} Turn` })) : ''] }), _jsx(VerticalLine, {}), _jsxs(Tic, { children: [_jsx("video", { autoPlay: true, width: remoteWidth, height: 190, ref: remoteVideoRef, muted: true }), loading ? _jsxs("div", { style: { color: 'green' }, children: ["'Looking for Partner.........'", resetData && _jsx("div", { style: { color: 'red' }, children: " partner got disconnect!!!! Again Looking for partner" })] }) : (_jsxs("div", { children: [_jsxs("div", { style: { color: 'red' }, children: ["Stranger's Name:", myName] }), _jsxs("div", { style: { color: 'red' }, children: ["Stranger's Location:", location?.city] }), _jsx("div", { style: { marginTop: 25 }, children: _jsx("button", { disabled: true, style: { color: 'white' }, onClick: handleReset, children: "Reset" }) }), _jsx("div", { style: { marginTop: 25, fontSize: 30 }, children: winner ? `Winner ${winVal}` : '' }), matrix.map((row, rowIndex) => (_jsx("div", { children: row.map((Element, colIndex) => (_jsx("button", { style: { color: 'red' }, disabled: true, onClick: (e) => handleClick(rowIndex, colIndex), children: Element }, colIndex))) }, rowIndex))), !winner ? (_jsx("div", { style: { marginTop: 25, fontSize: 30, color: 'green' }, children: draw ? `Draw ` : `Player ${preVal} Turn` })) : ''] }))] }), _jsx(VerticalLine, {}), _jsxs(ChatContainer, { children: [_jsx(Scroll, { children: chatArr.map((val, index) => _jsx(Chat, { ref: scrollRef, style: { color: `${val?.Stranger ? val?.Stranger.random : val?.You.random}` }, children: val?.Stranger ? `Stranger:${val?.Stranger.chat}` : `You:${val?.You.chat}` }, index)) }), _jsxs("div", { style: { display: 'flex', gap: 5 }, children: [_jsx("input", { autoFocus: true, ref: inputRef, type: "text", style: { width: '100%', fontSize: 16, height: 25, pointerEvents: 'all' }, onKeyDown: handleKeyDown, value: chat, onChange: (e) => {
                                                        setChat(e.target.value);
                                                    } }), _jsx("button", { ref: buttonRef, style: { color: 'red', padding: 0, height: 25, pointerEvents: 'all' }, onClick: (e) => handleChat(e), children: "Send" })] })] })] }) }))] }));
}
export default Room;
